...
not a bare `@docs/coder_brief.md` mention) with `deepseek-v4-pro` (not
the `[1m]` suffix Claude Code rejects as `unrecognized_model`). A
...
dashboard values stay owner-gated.
