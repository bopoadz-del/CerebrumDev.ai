...
#: Process restart (Render deploy) left a model_call NOTE with no live
#: WRITER / FACTORY_CODE_CLI worker. Not a silent 7230s watchdog lie.
NAMED_BLOCKER_CLI_ORPHANED = "FACTORY_CODE_CLI_ORPHANED"
