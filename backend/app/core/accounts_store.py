...
Pilot-grade persistence: a single-file database at ``STORAGE_PATH/accounts.db``.
Move to managed Postgres later by swapping this module; callers must not rely
on sqlite specifics.

Three credential types, all stored as SHA-256 hashes:
