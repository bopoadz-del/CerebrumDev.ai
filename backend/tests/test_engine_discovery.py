...
def test_resolve_engine_source_uses_default_ref_when_unset(
    ...
    def _run(args: List[str], **kwargs: Dict[str, Any]):
        return _fake_fetch(
            tmp_path, "d8987205f8fc6804526f4bc0165d036f4dc20c55", "https://github.com/bopoadz-del/Cerebrum-Blocks.git"
        )(args, **kwargs)
    ...
    assert metadata["ref"] == "d8987205f8fc6804526f4bc0165d036f4dc20c55"
    assert "commit_sha" in metadata
    assert root.is_dir()
...
def test_default_ref_is_pinned_commit(no_local_engine):
    ...
    assert DEFAULT_CEREBRUM_BLOCKS_REF == "d8987205f8fc6804526f4bc0165d036f4dc20c55"
