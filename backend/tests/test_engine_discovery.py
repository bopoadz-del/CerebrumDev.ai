...
def test_resolve_engine_source_uses_default_ref_when_unset(
    ...
    def _run(args: List[str], **kwargs: Dict[str, Any]):
        return _fake_fetch(
            tmp_path, "a198eba6655fabc68df06e3fab4f9c8089065b50", "https://github.com/bopoadz-del/Cerebrum-Blocks.git"
        )(args, **kwargs)
    ...
    assert metadata["ref"] == "a198eba6655fabc68df06e3fab4f9c8089065b50"
    assert "commit_sha" in metadata
    assert root.is_dir()
...
def test_default_ref_is_pinned_commit(no_local_engine):
    ...
    assert DEFAULT_CEREBRUM_BLOCKS_REF == "a198eba6655fabc68df06e3fab4f9c8089065b50"
