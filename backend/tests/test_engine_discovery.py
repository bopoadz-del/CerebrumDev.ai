...
def test_resolve_engine_source_uses_default_ref_when_unset(
    ...
    def _run(args: List[str], **kwargs: Dict[str, Any]):
        return _fake_fetch(
            tmp_path, "08c2724b85be1d8b07968818d35221775d15b6dd", "https://github.com/bopoadz-del/Cerebrum-Blocks.git"
        )(args, **kwargs)
    ...
    assert metadata["ref"] == "08c2724b85be1d8b07968818d35221775d15b6dd"
    assert "commit_sha" in metadata
    assert root.is_dir()
...
def test_default_ref_is_pinned_commit(no_local_engine):
    ...
    assert DEFAULT_CEREBRUM_BLOCKS_REF == "08c2724b85be1d8b07968818d35221775d15b6dd"
