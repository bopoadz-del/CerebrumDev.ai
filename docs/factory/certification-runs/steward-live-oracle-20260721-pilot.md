# Steward live oracle — PASS (10/10)

- **URL:** `https://cerebrum-steward.onrender.com`
- **Ran (UTC):** `2026-07-21T13:22:32Z`
- **Embedding used:** `fastembed:BAAI/bge-small-en-v1.5`
- **Suite:** `steward_live_oracle_v1` (issue #73)
...
| 7 | estate_property_isolation | pool chemicals east shed | 2 | 2 | estate-villa-manual | **PASS** |
| 8 | unknown_insufficiency_teleporter | What is the warranty procedure for the estate quantum teleporter array zxq? | 1 | ∅ | (insufficiency) | **PASS** |
| 9 | unknown_insufficiency_and_no_synthetic_policy | Describe the SOP for calibrating the fictional underwater laser chandelier ZX9 | 1 | ∅ | (insufficiency) | **PASS** |
